...
export class PizzIntIndicator {
  ...
  constructor() {
    ...
    this.element.innerHTML = `
      <button class="pizzint-toggle" title="${i18n.t('pizzint.title')}">
      ...
      <div class="pizzint-panel hidden">
        <div class="pizzint-header">
          <span class="pizzint-title">${i18n.t('pizzint.title')}</span>
        ...
        <div class="pizzint-tensions">
          <div class="pizzint-tensions-title">${i18n.t('pizzint.tensionsTitle')}</div>
          <div class="pizzint-tensions-list"></div>
        </div>
        <div class="pizzint-footer">
          <span class="pizzint-source">${i18n.t('pizzint.sourceLabel')} <a href="https://pizzint.watch" target="_blank" rel="noopener">PizzINT</a></span>
