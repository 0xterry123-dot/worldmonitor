    ...
    this.element.innerHTML = `
      <div class="mobile-warning-modal">
        <div class="mobile-warning-header">
          ...
          <span class="mobile-warning-title">${i18n.t('mobileWarning.title')}</span>
        </div>
        <div class="mobile-warning-content">
          <p>${i18n.t('mobileWarning.content1')}</p>
          <p>${i18n.t('mobileWarning.content2')}</p>
        </div>
        <div class="mobile-warning-footer">
          <label class="mobile-warning-remember">
            <input type="checkbox" id="mobileWarningRemember">
            <span>${i18n.t('mobileWarning.dontShowAgain')}</span>
          </label>
          <button class="mobile-warning-btn">${i18n.t('mobileWarning.gotIt')}</button>
        </div>
      </div>
    `;
