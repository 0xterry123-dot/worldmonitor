...
export class SearchModal {
  ...
  constructor(container: HTMLElement, options?: SearchModalOptions) {
    ...
    this.placeholder = options?.placeholder || i18n.t('searchModal.placeholder');
    this.hint = options?.hint || i18n.t('searchModal.hint');
    ...
    this.overlay.innerHTML = `
      <div class="search-modal">
        ...
        <div class="search-footer">
          <span><kbd>↑↓</kbd> ${i18n.t('searchModal.footer.navigate')}</span>
          <span><kbd>↵</kbd> ${i18n.t('searchModal.footer.select')}</span>
          <span><kbd>esc</kbd> ${i18n.t('searchModal.footer.close')}</span>
        </div>
      </div>
    `;
  ...
  private renderRecent(): void {
    ...
    this.resultsList.innerHTML = `<div class="search-section-header">${i18n.t('searchModal.recentSearches')}</div>`;
  ...
  private renderEmpty(): void {
    ...
    this.resultsList.innerHTML = `
      <div class="search-empty">
        ...
        <div>${i18n.t('searchModal.searchAllSources')}</div>
  ...
  private renderResults(): void {
    ...
    if (this.results.length === 0) {
      this.resultsList.innerHTML = `
        <div class="search-empty">
          <div class="search-empty-icon">∅</div>
          <div>${i18n.t('searchModal.noResults')}</div>
        </div>
      `;
      return;
    }
