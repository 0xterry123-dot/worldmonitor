...
export class ExportPanel {
  ...
  constructor(getDataFn: () => ExportData) {
    ...
    this.element.innerHTML = `
      <button class="export-btn" title="${i18n.t('common.export')}">⬇</button>
      <div class="export-menu hidden">
        <button class="export-option" data-format="csv">${i18n.t('common.exportCsv')}</button>
        <button class="export-option" data-format="json">${i18n.t('common.exportJson')}</button>
      </div>
    `;
